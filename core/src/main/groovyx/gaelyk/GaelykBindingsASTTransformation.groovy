...
class GaelykBindingsASTTransformation implements ASTTransformation {
	...
	void visit(ASTNode[] nodes, SourceUnit unit) {
		...
		addGetterIfNotExists(parent, User, "getUser", GaelykBindingsASTTransformation, "getCurrentUser")
		addGetterIfNotExists(parent, QueueAccessor, "getQueues", GaelykBindingsASTTransformation, "getQueues")
		addGetterIfNotExists(parent, Boolean, "getLocalMode", GaelykBindingsASTTransformation, "getLocalMode")
		addGetterIfNotExists(parent, Map, "getApp", GaelykBindingsASTTransformation, "getApp")
		addGetterIfNotExists(parent, LoggerAccessor, "getLogger", GaelykBindingsASTTransformation, "getLogger")
		addGetterIfNotExists(parent, Class, "getNamespace", GaelykBindingsASTTransformation, "getNamespaceManager")
	...
	private MethodNode makeServiceGetter(Class serviceClass, String accestorName, Class factoryClass, String factoryMethodName){
		def ast = new AstBuilder().buildFromSpec {
			method(accestorName, Opcodes.ACC_PRIVATE | Opcodes.ACC_STATIC, serviceClass) {
				parameters {}
				exceptions {}
				block {
					returnStatement {
	...
	// shortcut methods to keep the implementations simple
