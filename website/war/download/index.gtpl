...
<p>
The latest version was tested with Groovy 1.7-beta-2,
...
<h3>Artifacts</h3>
<ul>
    <li>Gaelyk JAR: <a href="http://cloud.github.com/downloads/glaforge/gaelyk/gaelyk-0.3.1.jar">gaelyk-0.3.jar</a></li>
    <li>Gaelyk template project: <a href="http://cloud.github.com/downloads/glaforge/gaelyk/gaelyk-template-project-0.3.1.zip">gaelyk-template-project-0.3.zip</a></li>
</ul>
